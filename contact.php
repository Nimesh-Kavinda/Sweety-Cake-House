...
<html lang="en" class="data-bs-theme">
  <head>
    ...
    <title>Sweety Cake House - Contact Page</title>
            ...
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
              ...
              <div class="col-12 col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="tel" class="form-control" id="number" name="number" value="" required autocomplete="off">
                </div>
              </div>
              <div class="col-12">
                <label for="message" class="form-label">Message <span class="text-danger">*</span></label>
                <textarea class="form-control" id="message" name="message" rows="3" required autocomplete="off"></textarea>
              </div>
              <div class="col-12">
                <div class="d-grid">
