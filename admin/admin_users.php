...
// Filter by user type (Admin or User)
$filter_user_type = '';
if (isset($_GET['user_type_filter'])) {
   $filter_user_type = $_GET['user_type_filter'];
}
...
<body class="d-flex flex-column min-vh-100">
   ...
   <section class="container my-5">
      ...
      <form action="admin_users.php" method="get" class="mb-4">
         ...
         <select name="user_type_filter" class="form-select" onchange="this.form.submit()">
         ...
         ?>
               <div class="col-md-4 mb-4">
                  <div class="card p-3 shadow-sm">
                     ...
                     <p><strong>Type:</strong> <span style="text-transform: capitalize;" class="<?php if ($fetch_users['user_type'] == 'admin') {
                                                                                                   echo 'text-danger';
